      ...
      <main className="min-h-screen pb-20 md:pb-0">
        ...
        <div className="py-6 px-4">
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-5 w-5 opacity-60" aria-hidden="true">
        ...
        <div className="max-w-4xl mx-auto px-4 py-8">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold mb-4" style={{ fontFamily: "'Playfair Display', Georgia, serif", color: '#1A1A18' }}>
              About
            </h2>
            <div className="bg-white rounded-xl p-6" style={{ border: '1px solid #EBEBEA', boxShadow: '0 1px 2px rgba(0,0,0,0.05)' }}>
          ...
          <section className="mb-8">
            ...
            <div className="grid gap-4">
              {[
                ...
                <div key={i} className="bg-white rounded-xl p-4" style={{ border: '1px solid #EBEBEA', boxShadow: '0 1px 2px rgba(0,0,0,0.05)' }}>
          ...
          <section className="mb-8">
            ...
            <div className="bg-white rounded-xl p-6" style={{ border: '1px solid #EBEBEA', boxShadow: '0 1px 2px rgba(0,0,0,0.05)' }}>
              <h3 className="font-semibold mb-2" style={{ color: '#1A1A18' }}>Pamantasan ng Lungsod ng Muntinlupa</h3>
              <p className="text-sm mb-4" style={{ color: '#5A5A56' }}>NBP Reservation, Brgy. Tunasan, Muntinlupa City, Metro Manila, Philippines 1773</p>
          ...
          <footer className="text-center pt-8" style={{ borderTop: '1px solid #EBEBEA' }}>
            <p className="text-sm" style={{ color: '#9A9A95' }}>{COPY.footer.copyright}</p>
            <p className="text-xs mt-1" style={{ color: '#9A9A95' }}>{COPY.footer.rightsReserved}</p>
          </footer>
        </div>
      </main>
    </>
