...
export default function ManagePostsPage() {
  ...
  const fetchAnnouncements = async () => {
    const { data } = await supabase
      .from('announcements')
      .select(`
        id, title, status, created_at, start_datetime,
        publisher:users!publisher_user_id(full_name),
                ...
                <div className="flex items-start justify-between gap-3">
                    ...
                    <div className="flex items-center gap-2 mb-1 flex-wrap">
                      {ann.category && (
                        <span
                          ...
                          style={{ backgroundColor: ann.category.color }}
                        >
                          {ann.category.name}
                        </span>
                      )}
                      <span
                        ...
                        style={{
                          backgroundColor: `${statusColor[ann.status]}20`,
                          color: statusColor[ann.status] || '#5A5A56'
                        }}
                      >
                        {ann.status}
                      </span>
                  ...
                  {confirmId === ann.id ? (
                    ...
                    <button
                      ...
                      className="p-2 rounded-lg flex-shrink-0 hover:bg-red-50 transition-colors"
                      title="Delete post"
                    >
...
EOFmkdir -p sentro-pilimon/app/dashboard/admin/posts
cat > sentro-pilimon/app/dashboard/admin/posts/page.tsx << 'EOF'
'use client'
