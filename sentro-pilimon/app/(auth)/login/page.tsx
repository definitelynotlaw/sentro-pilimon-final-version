      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl p-6 md:p-8" style={{ border: '1px solid #EBEBEA', boxShadow: '0 10px 15px -3px rgba(0,0,0,0.1)' }}>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {/* Error */}
            {error && (
              <div className="p-3 rounded-lg text-sm" style={{ backgroundColor: error.includes('Check your email') ? '#F0FDF4' : '#FEF2F2', border: `1px solid ${error.includes('Check your email') ? '#BBF7D0' : '#FECACA'}`, color: error.includes('Check your email') ? '#166534' : '#9B1C1C' }}>
                {error}
              </div>
            )}
